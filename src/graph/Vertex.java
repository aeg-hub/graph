...
public class Vertex {
    ...
    /**
     * Erstellt einen neuen Knoten mit der ID pID.
    ...
    /**
     * Liefert die ID des Knotens als String.
     * Hinweis: Gib eine neue Kopie des Strings zurueck (new String(id)),
    ...
    /**
     * Setzt die Markierung des Knotens auf pMark.
    ...
    /**
     * Liefert true, wenn der Knoten markiert ist, sonst false.
